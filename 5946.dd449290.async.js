"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[5946],{65946:function(F,g,l){l.r(g);var w=l(168400),h=l.n(w),y=l(97857),P=l.n(y),o=l(694393),u=l(65630),k=l(454769),f=l(667294),c=l(785893),m,x,v,b,E;o.ZP.registerNode("behavior-start-node",{draw:function(e,n){var d=o.ZP.Util.getTextSize(e.label,16)[0],r=[d+20*2,48],t=n.addShape("rect",{name:"start-node",attrs:{width:r[0],height:r[1],y:-r[1]/2,radius:8,fill:"#fff"}});return n.addShape("text",{attrs:{text:"".concat(e.label),fill:"rgba(0, 0, 0, 0.88)",fontSize:16,fontWeight:500,x:20,textBaseline:"middle"},name:"start-node-text"}),t},getAnchorPoints:function(){return[[0,.5],[1,.5]]}}),o.ZP.registerNode("behavior-sub-node",{draw:function(e,n){var d=o.ZP.Util.getTextSize(e.label,14)[0],r=16,t=[d+16*2+(e.targetType?12:0)+(e.link?20:0),40],s=n.addShape("rect",{name:"sub-node",attrs:{width:t[0],height:t[1],y:-t[1]/2,radius:8,fill:"#fff",cursor:"pointer"}});if(n.addShape("text",{attrs:{text:"".concat(e.label),x:e.targetType?12+16:r,fill:"rgba(0, 0, 0, 0.88)",fontSize:14,textBaseline:"middle",cursor:"pointer"},name:"sub-node-text"}),e.targetType&&n.addShape("rect",{name:"sub-node-type",attrs:{width:8,height:8,radius:4,y:-4,x:12,fill:e.targetType==="mvp"?"#1677ff":"#A0A0A0",cursor:"pointer"}}),e.children){var i=e.children,a=i.length;n.addShape("rect",{name:"sub-node-children-length",attrs:{width:20,height:20,radius:10,y:-10,x:t[0]-4,fill:"#404040",cursor:"pointer"}}),n.addShape("text",{name:"sub-node-children-length-text",attrs:{text:"".concat(a),x:t[0]+6-o.ZP.Util.getTextSize("".concat(a),12)[0]/2,textBaseline:"middle",fill:"#fff",fontSize:12,cursor:"pointer"}})}return e.link&&n.addShape("dom",{attrs:{width:16,height:16,x:t[0]-12-16,y:-8,cursor:"pointer",html:`
          ...
          `},name:"sub-node-link"}),s},getAnchorPoints:function(){return[[0,.5],[1,.5]]},options:{stateStyles:{hover:{stroke:"#1677ff","sub-node-link":{html:`
            <div style="width: 16px; height: 16px;">
              <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <g id="\u9875\u9762-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="DatePicker" transform="translate(-890.000000, -441.000000)" fill-rule="nonzero">
          ...
          `}}}}},"rect");var M=function(e){var n=function d(r){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,s=P()({},r);switch(t){case 0:s.type="behavior-start-node";break;case 1:s.type="behavior-sub-node",s.collapsed=!0;break;default:s.type="behavior-sub-node";break}return r.children&&(s.children=r.children.map(function(i){return d(i,t+1)})),s};return n(e)},D=(0,u.kc)(function(){return{container:(0,u.iv)(m||(m=h()([`
    width: 100%;
    height: 600px;
  ...
  `])))}}),B=function(e){var n=e.data,d=(0,f.useRef)(null),r=D(),t=r.styles,s=(0,k.eL)();return(0,f.useEffect)(function(){var i=new o.ZP.TreeGraph({container:d.current,width:d.current.scrollWidth,height:d.current.scrollHeight,renderer:"svg",modes:{default:["collapse-expand","drag-canvas"]},defaultEdge:{type:"cubic-horizontal",style:{lineWidth:1,stroke:"#BFBFBF"}},layout:{type:"mindmap",direction:"LR",getHeight:function(){return 48},getWidth:function(p){return o.ZP.Util.getTextSize(p.label,16)[0]+40},getVGap:function(){return 10},getHGap:function(){return 60},getSide:function(p){return p.data.direction}}});i.on("node:mouseenter",function(a){i.setItemState(a.item,"hover",!0)}),i.on("node:mouseleave",function(a){i.setItemState(a.item,"hover",!1)}),i.on("node:click",function(a){var p=a.item.getModel(),C=p.link;C&&(window.location.hash=C)}),i.data(M(n)),i.render(),i.fitCenter()},[]),(0,c.jsxs)("div",{ref:d,className:t.container,children:[(0,c.jsx)("div",{className:t.title,children:"".concat(s.frontmatter.title," \u884C\u4E3A\u6A21\u5F0F\u5730\u56FE")}),(0,c.jsxs)("div",{className:t.tips,children:[(0,c.jsx)("div",{className:t.mvp,children:"MVP \u884C\u4E3A\u76EE\u7684"}),(0,c.jsx)("div",{className:t.extension,children:"\u62D3\u5C55\u884C\u4E3A\u76EE\u7684"})]})]})};g.default=B}}]);
